...
var checkStateConsistencyCreator = function (_a) {
    var _b = (_a === void 0 ? {} : _a).level, level = _b === void 0 ? LEVELS.error : _b;
    return function (state, action) {
        ...
        if (errors.length > 0) {
            var message = "State consistency error for action " + action.type;
